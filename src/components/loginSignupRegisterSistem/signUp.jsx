        ...
        <div className={stylesSignUp.containerLoginSignUpEmailPassword} >
            <div className={stylesSignUp.containerDivLoginSignUpEmailPassword}>
                ...
                <form className={stylesSignUp.formLoginSignUpContainer} action="" onSubmit={submitCreateUser} >
                    ...
                    {isRegistrer &&(
                        <div className={uiStyles.retroalimentacionDiv}>
                            <p className={stylesText.text13px}>User registered. Verify your email by clicking on the link sent to your email. If you don't receive the link, please check in your spam box.</p>
                        </div>)
                    }
                </form>
